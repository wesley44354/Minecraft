...
public class Player : MonoBehaviour
{
    ...
    public float boundsTolerance = 0.01f;  
    ...
    private void CalculateVelovity()
    {
        ...
        // If we're sprinting, use the sprit multiplier.
        if (isSprinting)
        {
    ...
    {
        if (world.CheckForVoxel(transform.position.x - playerWidth, transform.position.y + 2 + upSpeed, transform.position.z - playerWidth) ||
